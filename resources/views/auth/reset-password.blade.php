<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" placeholder="Enter your email" />
