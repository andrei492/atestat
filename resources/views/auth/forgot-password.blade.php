<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-400 text-sm leading-relaxed">No problem. Enter your email and we'll send you a reset link.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('login') }}" class="inline-flex items-center text-sm text-purple-400 hover:text-purple-300 transition">
